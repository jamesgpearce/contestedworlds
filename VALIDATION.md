...
- Broad browser visual/click-through and screen-reader QA were not performed. Appearance behavior is covered by the four automated module tests; responsive styling was reviewed in source. These checks are not a browser accessibility audit.
